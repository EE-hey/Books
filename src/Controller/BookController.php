...
#Add the use corresponding to abstract normalizer
...
class BookController extends AbstractController
{
    ...
    public function createBook(Request $request, SerializerInterface $serializer, EntityManagerInterface $em, UrlGeneratorInterface $urlGenerator, AuthorRepository $authorRepository)
    {
